...
class TestBucketList(BaseClass):
    ...
    def test_bucketlist_creation(self):
        ...
        response = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
    ...
    def test_bucketlist_creation_with_special_characters(self):
        ...
        response = self.test_client.post('/bucketlists/', data=faulty_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_create_bucket_list_with_no_name(self):
        ...
        bucketlist1 = {'name': ''}
        response = self.test_client.post('/bucketlists/', data=bucketlist1,
                                 headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_create_bucket_list_that_already_exists(self):
        ...
        response = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
        self.assertTrue(response.status_code == 201)
        response2 = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_delete_bucket_list(self):
        ...
        self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
        response = self.test_client.delete('/bucketlists/1', headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_edit_bucket_list(self):
        ...
        post_response = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
        self.assertEqual(post_response.status_code, 201)
        put_response = self.test_client.put('/bucketlists/1', data=data2,
                                headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_fetching_a_bucket_list_by_id(self):
        ...
        post_response = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
        get_response = self.test_client.get('/bucketlists/1',
                                headers={"Authorization": 'Bearer ' + self.token})
    ...
    def test_fetching_bucket_lists(self):
        ...
        post_response = self.test_client.post('/bucketlists/', data=self.new_bucketlist,
                                 headers={"Authorization": 'Bearer ' + self.token})
        self.assertEqual(post_response.status_code, 201)
        get_response = self.test_client.get('/bucketlists/',
                                headers={"Authorization": 'Bearer ' + self.token})
